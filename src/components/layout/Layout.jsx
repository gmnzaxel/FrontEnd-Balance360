...
const Layout = () => {
  ...
  const navItems = useMemo(() => {
    ...
    if (user?.is_superuser && !isImpersonating) {
      return [{ path: '/super-dashboard', label: 'Panel SuperAdmin' }]
    }
    ...
    <div className="app-shell">
      ...
      <div className="app-main">
        <Header
          ...
          menuSlot={<UserMenu user={effectiveUser} onLogout={logout} onNavigate={handleNavigate} />}
        />
        ...
        {user?.is_superuser && localStorage.getItem('impersonated_company_id') && (
          <div
            style={{
              background:
                'linear-gradient(90deg, rgba(245, 158, 11, 0.12) 0%, rgba(251, 191, 36, 0.08) 100%)',
