...
const Settings = () => {
  ...
  return (
    <div className="settings-page page page-container">
                ...
                <div className="settings-row-content">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted">
                      Oculta reportes, usuarios y accesos administrativos cuando usás una PC
                      pública.
                    </p>
                  </div>
                </div>
        ...
        <div className="card settings-card">
          <div className="card-header settings-card-header settings-card-header-split">
            <div className="settings-ticket-head">
              ...
              <p className="text-sm text-muted settings-ticket-subtitle">
                Edita el texto del comprobante.
              </p>
            </div>
            <Button
              type="button"
              ...
              <div className="settings-logo-label">
                ...
                <div>
                  <p className="font-semibold text-sm">
                    Logo del negocio <span className="text-muted font-normal">(opcional)</span>
                  </p>
                  <p className="text-xs text-muted">
                    Se mostrará en la parte superior de tus tickets y presupuestos. Máx. 500 KB.
                  </p>
                </div>
              </div>
      ...
      {showPreview && (
        <Modal title="Vista previa del ticket" onClose={() => setShowPreview(false)} size="md">
          <div
            className="settings-preview-wrap"
            style={{ background: 'var(--slate-900)', padding: '20px', borderRadius: '8px' }}
          >
            <div
              className="settings-preview-ticket"
              style={{
                background: 'white',
                color: 'black',
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '14px' : '16px',
                      fontWeight: 'bold',
                ...
                <div
                  className="company"
                  style={{
                    fontSize: settings.ticket_width === '58mm' ? '10px' : '11px',
                    color: '#000',
                    marginBottom: '5px',
                    whiteSpace: 'pre-wrap',
                  }}
                ...
                {settings.ticket_address && (
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '9px' : '10px',
                      color: '#000',
                    }}
                  >
                    Dirección: {settings.ticket_address}
                  </div>
                )}
                {settings.ticket_cuit && (
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '9px' : '10px',
                      color: '#000',
                  ...
                  >
                    CUIT: {settings.ticket_cuit}
                  </div>
                )}
                {settings.ticket_iibb && (
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '9px' : '10px',
                      color: '#000',
                ...
                {settings.ticket_iva && (
                  ...
                  >
                    IVA: {settings.ticket_iva}
                  </div>
                )}
                {settings.ticket_phone && (
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '9px' : '10px',
                      color: '#000',
                  ...
                  >
                    Tel: {settings.ticket_phone}
                  </div>
                )}
                {settings.ticket_email && (
                  <div
                    style={{
                      fontSize: settings.ticket_width === '58mm' ? '9px' : '10px',
                      color: '#000',
                ...
                <thead>
                  <tr style={{ borderBottom: '1px solid #000' }}>
                    <th
                      style={{
                        textAlign: 'left',
                        width: settings.ticket_width === '58mm' ? '50%' : '55%',
                        fontSize: settings.ticket_width === '58mm' ? '10px' : '12px',
                      }}
                    >
                      Producto
                    </th>
                  ...
                  {settings.ticket_width === '58mm' ? (
                    <>
                      <tr>
                        <td
                          colSpan="3"
                          style={{ padding: '4px 0 0 0', fontSize: '11px', fontWeight: 'bold' }}
                        >
                          CAMISA LINO
                        </td>
                      </tr>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: 'bold',
                    fontSize: settings.ticket_width === '58mm' ? '13px' : '14px',
                    marginTop: '5px',
                  }}
                >
                  <span>TOTAL:</span>
              ...
              >
                ...
                <p
                  style={{
                    marginTop: '5px',
                    fontSize: settings.ticket_width === '58mm' ? '8px' : '9px',
                    color: '#000',
                  }}
                >
                  *** Copia Cliente ***
