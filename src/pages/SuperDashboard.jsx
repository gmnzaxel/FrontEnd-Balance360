  ...
  return (
    ...
    >
      <div>
        ...
        de <strong style={{ color: 'var(--text-primary)' }}>{totalItems}</strong> registros
      </div>
...
const SuperDashboard = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success(
        `Empresa "${confirmDelete.name}" y todos sus registros asociados han sido purgados permanentemente.`,
      )
  ...
  const exportCompaniesCSV = () => {
    ...
    link.setAttribute(
      'download',
      `empresas_balance360_${new Date().toISOString().slice(0, 10)}.csv`,
    )
  ...
  const exportLogsCSV = () => {
    ...
    link.setAttribute(
      'download',
      `auditoria_logins_balance360_${new Date().toISOString().slice(0, 10)}.csv`,
    )
    document.body.appendChild(link)
    link.click()
    document.body.removeChild(link)
  ...
  useEffect(() => {
    setLogsPage(1)
  }, [logsSearchTerm, logStatusFilter, logTimeFilter])

  return (
    <div
      className="page"
      style={{ animation: 'fadeIn var(--duration-enter) var(--ease-out-expo) both' }}
    >
      {/* Header */}
      <div className="page-header">
        <div className="page-header-title">
          ...
          <p className="page-subtitle">
            Visualizá métricas, auditá accesos, administrá y gestioná empresas del sistema.
          </p>
        </div>
            ...
            globalMetrics && (
              <div className="kpi-grid" style={{ marginBottom: '24px' }}>
                <div className="card kpi-card">
                  ...
                  >
                    <div>
                      <p className="muted small" style={{ margin: 0, fontSize: '0.85rem' }}>
                  ...
                  >
                    <div>
                      ...
                      <h3 className="kpi-value" style={{ margin: '4px 0 0 0', fontSize: '1.3rem' }}>
                        {globalMetrics.total_sales} ($
                        {globalMetrics.total_revenue.toLocaleString('es-AR', {
                      ...
                      <React.Fragment key={company.id}>
                        ...
                        >
                          ...
                          <td
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              handleCopyText(company.phone, 'Teléfono')
                            }}
                          >
                            <div
                              className="flex-row gap-xs items-center"
                              style={{ cursor: company.phone ? 'pointer' : 'default' }}
                          ...
                          <td
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              handleCopyText(company.address, 'Dirección')
                            }}
                          >
                            <div
                              className="flex-row gap-xs items-center"
                              style={{ cursor: company.address ? 'pointer' : 'default' }}
                              title="Clic para copiar"
                            >
                              ...
                              {(() => {
                                ...
                                return (
                                  <Button
                                    ...
                                    size="sm"
                                    icon={
                                      isCurrentAudit ? <ShieldCheck size={14} /> : <Eye size={14} />
                                    }
                                    ...
                                    title={
                                      isCurrentAudit
                                        ? 'Actualmente auditando esta empresa'
                        ...
                        {expandedCompanyId === company.id && (
                          <tr>
                            <td
                              colSpan="7"
                              style={{ background: 'rgba(15, 23, 42, 0.35)', padding: '16px 24px' }}
                            >
                              <div
                                  ...
                                  <div className="grid three-cols gap-sm">
                                    ...
                                    >
                                      ...
                                      <div>
                                        ...
                                        >
                                          {companyDetails[company.id].stats.products_count ?? 0}{' '}
                                          items
                                        </strong>
                                      </div>
                                    </div>
                                    ...
                                    >
                                      ...
                                      <div>
                                        ...
                                        >
                                          {companyDetails[company.id].stats.sales_count ?? 0} ($
                                          {(
                                            companyDetails[company.id].stats.total_revenue || 0
                                          ...
                                          >
                                            <div>
                                              ...
                                              >
                                                {u.username}
                                                <span
                                                  className={`badge ${isUserActive ? 'badge-success' : 'badge-neutral'}`}
                                                  style={{
                                                    fontSize: '0.65rem',
                                                    padding: '2px 6px',
                                                  }}
                      ...
                      <div className="empty-state">
                        ...
                        <p>
                          {searchTerm
                            ...
                            : 'Creá la primera empresa con el botón de arriba.'}
                        </p>
                      </div>
                    </td>
                  </tr>
                  ...
                  paginatedLogs.map((log) => {
                    ...
                    return (
                      <tr key={log.id}>
                        ...
                        <td data-label="Empresa / Ecosistema" className="text-muted">
                          {log.company_name || '—'}
                        </td>
                        <td
                  ...
                  <tr>
                    <td colSpan="6">
                      <div className="empty-state">
                        <Users size={40} />
                        <p>
                          {logsSearchTerm || logStatusFilter !== 'ALL' || logTimeFilter !== 'ALL'
      ...
      {confirmDelete && (
        <div
          ...
          onClick={() => !deletingId && (setConfirmDelete(null), setDeleteConfirmationInput(''))}
        >
          <div
            className="ui-modal"
          ...
          >
            ...
            >
              <div className="inline-notice inline-notice-error">
                ...
                <div>
                  <strong>Esta acción es física e irreversible.</strong>
                  <br />
                  Se eliminarán permanentemente de la base de datos la empresa, todos sus usuarios,
                  productos, ventas, movimientos y configuraciones.
                </div>
              </div>
              <p
                style={{
              ...
              >
                ...
                escribí su nombre exacto a continuación:
              </p>
              <Input
        ...
        >
          <form onSubmit={handleSubmit} className="form-stack">
            ...
            <div className="auth-note mt-3">
              ...
              Se creará automáticamente la empresa junto con sus configuraciones y el usuario
      ...
      {resetUser && (
        <Modal
          ...
          onClose={() => !resettingPassword && setResetUser(null)}
          footer={
            <>
              <Button
                variant="ghost"
              ...
              <Button variant="primary" onClick={handleResetPassword} disabled={resettingPassword}>
                {resettingPassword ? 'Restableciendo…' : 'Guardar Nueva Contraseña'}
              </Button>
            </>
          }
        >
